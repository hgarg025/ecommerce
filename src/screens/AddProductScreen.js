...
const [productCategory, setProductCategory] = useState('');
    ...
    <Button title="Submit" onPress = {() => {setProductDetails([...productDetails,{name : productName, price : productPrice, quantity : productQuantity, edate : productEdate, category : productCategory}])}}/>
